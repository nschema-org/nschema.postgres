...
public sealed class PostgresSqlGeneratorTests(PostgresContainerFixture fixture) : IAsyncLifetime
{
    ...
    public async Task CreateSchema_CreatesSchemaInDatabase()
    {
        ...
        // Act
        await _executor.Execute(_generator.Generate(new MigrationPlan([new CreateSchema(name)])));
    ...
    public async Task DropSchema_RemovesSchemaFromDatabase()
    {
        ...
        // Act
        await _executor.Execute(_generator.Generate(new MigrationPlan([new DropSchema(name)])));
    ...
    public async Task RenameSchema_RenamesSchemaInDatabase()
    {
        ...
        // Act
        await _executor.Execute(_generator.Generate(new MigrationPlan([new RenameSchema(oldName, newName)])));
    ...
    public async Task CreateTable_CreatesTableInDatabase()
    {
        ...
        // Act
        await _executor.Execute(_generator.Generate(new MigrationPlan([new CreateTable(_schema, table)])));
    ...
    public async Task DropTable_RemovesTableFromDatabase()
    {
        ...
        // Act
        await _executor.Execute(_generator.Generate(new MigrationPlan([new DropTable(_schema, "products")])));
    ...
    public async Task RenameTable_RenamesTableInDatabase()
    {
        ...
        // Act
        await _executor.Execute(_generator.Generate(new MigrationPlan([new RenameTable(_schema, "old_name", "new_name")])));
    ...
    public async Task AddColumn_AddsColumnToTable()
    {
        ...
        // Act
        await _executor.Execute(_generator.Generate(new MigrationPlan([new AddColumn(_schema, "items", column)])));
    ...
    public async Task DropColumn_RemovesColumnFromTable()
    {
        ...
        // Act
        await _executor.Execute(_generator.Generate(new MigrationPlan([new DropColumn(_schema, "items", Column.Create("name", SqlType.Text))])));
    ...
    public async Task RenameColumn_RenamesColumnInTable()
    {
        ...
        // Act
        await _executor.Execute(_generator.Generate(new MigrationPlan([new RenameColumn(_schema, "items", "old_col", "new_col")])));
    ...
    public async Task AlterColumnType_ChangesColumnDataType()
    {
        ...
        // Act
        await _executor.Execute(_generator.Generate(new MigrationPlan([new AlterColumnType(_schema, "items", "value", SqlType.Int, SqlType.BigInt)])));
    ...
    public async Task AlterColumnNullability_MakesColumnNotNull()
    {
        ...
        // Act
        await _executor.Execute(_generator.Generate(new MigrationPlan([new AlterColumnNullability(_schema, "items", "name", OldNullable: true, NewNullable: false)])));
    ...
    public async Task AlterColumnNullability_MakesColumnNullable()
    {
        ...
        // Act
        await _executor.Execute(_generator.Generate(new MigrationPlan([new AlterColumnNullability(_schema, "items", "name", OldNullable: false, NewNullable: true)])));
    ...
    public async Task SetColumnDefault_SetsDefaultExpression()
    {
        ...
        // Act
        await _executor.Execute(_generator.Generate(new MigrationPlan([new SetColumnDefault(_schema, "items", "quantity", null, "0")])));
    ...
    public async Task SetColumnDefault_DropsDefaultExpression()
    {
        ...
        // Act
        await _executor.Execute(_generator.Generate(new MigrationPlan([new SetColumnDefault(_schema, "items", "quantity", "0", null)])));
    ...
    public async Task AddPrimaryKey_AddsConstraintToTable()
    {
        ...
        // Act
        await _executor.Execute(_generator.Generate(new MigrationPlan([new AddPrimaryKey(_schema, "items", new PrimaryKey("pk_items", ["id"]))])));
    ...
    public async Task DropPrimaryKey_RemovesConstraintFromTable()
    {
        ...
        // Act
        await _executor.Execute(_generator.Generate(new MigrationPlan([new DropPrimaryKey(_schema, "items", "pk_items")])));
    ...
    public async Task AddForeignKey_AddsReferentialConstraint()
    {
        ...
        // Act
        await _executor.Execute(_generator.Generate(new MigrationPlan([new AddForeignKey(_schema, "children", fk)])));
    ...
    public async Task DropForeignKey_RemovesReferentialConstraint()
    {
        ...
        // Act
        await _executor.Execute(_generator.Generate(new MigrationPlan([new DropForeignKey(_schema, "children", "fk_children_parent")])));
    ...
    public async Task CreateIndex_CreatesIndexOnTable()
    {
        ...
        // Act
        await _executor.Execute(_generator.Generate(new MigrationPlan([new CreateIndex(_schema, "items", index)])));
    ...
    public async Task DropIndex_RemovesIndexFromTable()
    {
        ...
        // Act
        await _executor.Execute(_generator.Generate(new MigrationPlan([new DropIndex(_schema, "items", "idx_items_name")])));
    ...
    public async Task RunScript_PreDeployment_ExecutesSql()
    {
        ...
        // Act
        await _executor.Execute(_generator.Generate(new MigrationPlan([new RunScript(script)])));
    ...
    public async Task Execute_FailingStatement_RollsBackEarlierSchemaChanges()
    {
        ...
        await Should.ThrowAsync<PostgresException>(() =>
            _executor.Execute(_generator.Generate(new MigrationPlan(planActions))));
